...
<code><p>&lt;script type="text/javascript"&gt;</p>
    $("#fakeLoader").fakeLoader({
            ...
            timeToHide:1200, //Time in milliseconds for fakeLoader disappear, if the value is 0, overlay will not disappear, you need to remove it by yourself
            zIndex:999, // Default zIndex
            spinner:"spinner1",//Options: 'spinner1', 'spinner2', 'spinner3', 'spinner4', 'spinner5', 'spinner6', 'spinner7' 
            bgColor:"#2ecc71", //Hex, RGB or RGBA colors
            imagePath:"yourPath/customizedImage.gif", //If you want can you insert your custom image
            opacity:0.8 // Default opacity is 1
